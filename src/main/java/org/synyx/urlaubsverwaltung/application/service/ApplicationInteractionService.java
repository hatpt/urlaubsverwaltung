...
public interface ApplicationInteractionService {
     ...
     * @return the application for leave of the cancelled cancellation request
     */
    Application cancelCancellationRequest(Application application, Person canceller, Optional<String> comment);
